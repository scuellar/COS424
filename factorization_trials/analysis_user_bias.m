%% Summary:
% Method 3. Use factorization model with mean, business and user bias
%
% Assumption: everything matters
%
% Details:
...
for l=1:size(lambda,2)
    for k=1:size(numlf,2)
        ...
        [U,B,mymu,bu,bb] = factorize_bias(training,numlf(k),lambda(l),lrate(k),50);
...
[U,B,mymu,bu,bb] = factorize_bias(ratings,b_numlf,b_lambda,0.1,60);
